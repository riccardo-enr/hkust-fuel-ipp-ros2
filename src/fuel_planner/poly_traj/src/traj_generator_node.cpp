...
TrajGeneratorNode::TrajGeneratorNode(const rclcpp::NodeOptions & options)
...
void TrajGeneratorNode::odomCallback(const nav_msgs::msg::Odometry::SharedPtr msg)
{
...
void TrajGeneratorNode::generateTrajectory()
{
...
void TrajGeneratorNode::commandTimer()
{
  if (!traj_active_) {
    return;
  }
...
void TrajGeneratorNode::displayPathWithColor(
...
void TrajGeneratorNode::drawState(
