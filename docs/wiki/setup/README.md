...
Capture everything needed to reproduce the dev environment locally or in CI.
...
Feel free to add scenario-specific guides (e.g., hardware bring-up) as their own Markdown files and link them here.
